			...
			<div class="row">
                <div class="col-xl-12">
                    ...
                    <div class="m-portlet">
                        ...
                        <!--begin::Form-->
                        <form class="m-form m-form--state m-form--fit m-form--label-align-right" id="opciones" action="#" method="get">
                        ...
                        <div class="m-portlet__body">
                            ...
                            <!--begin: Datatable -->
                            <table class="opciones-table" id="opciones-table" width="100%">
                                <thead>
                                    <tr>
                                        <th title="id">
                                            Id
